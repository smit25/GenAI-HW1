...
# -----------------------------------------------------------------------------
#python chargpt.py --data.block_size=16 --system.work_dir=./out/chargpt1 --model.n_query_head=6 --model.n_kv_head=3 --model.rope=False --trainer.device=cpu --trainer.max_iters=600 --model.pretrained_folder=./out/chargpt1
